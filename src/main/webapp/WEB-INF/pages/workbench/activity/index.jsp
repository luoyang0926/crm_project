...
<script type="text/javascript">
	...
	$(function(){
		...
		var pageSize=10;
		$.ajax({
			url:'workbench/activity/ForPage.do',
			data:{
				owner:owner,
				name:name,
				beginDate:beginDate,
			...
			success: function (data) {
				...
				$("#totalRowsB").text(data.allCounts);
				var htmlStr = "";
				$.each(data.activityList, function (index,obj) {
					...
					htmlStr+="  <td><a style=\"text-decoration: none; cursor: pointer;\" onclick=\"window.location.href='detdetail.jsp>发传单</a></td>\";
       ...
       $("#importActivityBtn").click(function () {
           ...
           //发送请求
           $.ajax({
               url:'workbench/settings/importActivity.do',
               data:formData,
       ...
       $.ajax({
           ...
           success:function (data) {
               ...
               $.each(data.activityList,function (index,obj) {
                   htmlStr+="<tr class=\"active\">";
                   htmlStr+="<td><input type=\"checkbox\" value=\""+obj.id+"\"/></td>";
                   htmlStr+="<td><a style=\"text-decoration: none; cursor: pointer;\" onclick=\"window.location.href='workbench/settings/details.do?id="+obj.id+"'\">"+obj.name+"</a></td>";
               ...
               <div class="modal-body">
                   ...
                   <form id="createActivityForm" class="form-horizontal" role="form">
                       ...
                       <div class="form-group">
                           <label for="create-marketActivityOwner" class="col-sm-2 control-label" id="owner">所有者<span style="font-size: 15px; color: red;">*</span></label>
                           ...
                           <label for="create-marketActivityName" class="col-sm-2 control-label" id="name">名称<span style="font-size: 15px; color: red;">*</span></label>
                           <div class="col-sm-10" style="width: 300px;">
                       ...
                       <div class="form-group">
                           <label for="create-startDate" class="col-sm-2 control-label" id="beginDate">开始日期</label>
                           <div class="col-sm-10" style="width: 300px;">
                               <input type="text" class="form-control mydate" name="mydate" id="create-startDate" readonly>
                           </div>
                           <label for="create-endDate" class="col-sm-2 control-label" id="endDate">结束日期</label>
                           <div class="col-sm-10" style="width: 300px;">
