...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#updatePwd").click(function () {
			...
			$.ajax({
				url:'settings/qx/user/updateUserPwd.do',
				data:{
					oldPwd:oldPwd,
					newPwd:newPwd
				},
				...
				success: function (data) {
					if (data.code == 1) {
						...
						/*$("#editPwdModal").model("hide");*!/*/
					} else {
						alert(data.message);
						window.location.href = "settings/qx/user/toLogin.do";
						//$("#editPwdModal").model("show");
					}
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						<div class="form-group">
							<label for="oPwd" class="col-sm-2 control-label">原密码</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="oPwd" style="width: 200%;">
							</div>
						</div>
