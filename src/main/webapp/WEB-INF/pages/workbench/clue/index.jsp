...
<script type="text/javascript">
	...
	$(function(){
        ...
        $("#saveCreateClueBtn").click(function () {
            ...
            //发送请求
            $.ajax({
                url:'workbench/activity/insertClue.do',
                data:{
                     fullname       :fullname       ,
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detailClue.do?id=9d6c48035da442d3a115edb449ef9b03';">张三教授</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
